...
if (conditional.includes(base_url_website)) {
    bg_color_icon = "#003577";
} else {
    bg_color_icon = "#003577e0";
}
...
<div class="circle_aksesbilitas_2">
    <div class="circle_aksesbilitas_3">
        <svg id="Layer_1" width="20px" height="20px" class="svg_icon_popoup_dsb" version="1.1" viewBox="0 0 301.673 226.145" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g>
